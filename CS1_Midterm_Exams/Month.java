 ...
 * For example, the following dates are all considered to be at least a month apart from 9/19 (September 19):
 ...
 * Note that the first date could come before or after (or be the same as) the second date.
