 ...
 * and that prints a series of n randomly generated two-digit numbers.
 * The method should use the Random object to select numbers in the range of 10 to 99 inclusive
 * where each number is equally likely to be chosen. The method should indicate whether the number 42 was selected.
 * For example, given the following lines of code:
 *
 * Random r = new Random();
 * printTwoDigit(r, 4);
 *
